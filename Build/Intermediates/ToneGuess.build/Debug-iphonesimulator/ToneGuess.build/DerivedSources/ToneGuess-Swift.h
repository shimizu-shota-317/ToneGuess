...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ToneGuess",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9ToneGuess11AppDelegate")
...
SWIFT_CLASS("_TtC9ToneGuess18MainViewController")
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified D4Tone;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified E4Tone;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified F4Tone;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified G4Tone;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified A4Tone;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified B4Tone;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified C5Tone;
- (IBAction)onSettingButtonTapped:(UIButton * _Nonnull)sender;
- (IBAction)onSoundButtonTapped:(UIButton * _Nonnull)sender;
- (IBAction)onNextButtonTapped:(UIButton * _Nonnull)sender;
...
- (IBAction)onF4ButtonTapped:(UIButton * _Nonnull)sender;
- (IBAction)onG4ButtonTapped:(UIButton * _Nonnull)sender;
...
SWIFT_CLASS("_TtC9ToneGuess21SettingViewController")
@interface SettingViewController : UIViewController <UIPickerViewDataSource, UIPickerViewDelegate>
@property (nonatomic, weak) IBOutlet UIPickerView * _Null_unspecified timbrePicker;
